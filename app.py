...
entry_date = st.sidebar.date_input("Date", value=pd.to_datetime(settings.get(f"last_date_{account}", str(date.today()))))
...
start_balance_input = st.sidebar.number_input("Starting Balance",
                                              value=st.session_state[f"start_balance_{account}"],
                                              step=100.0, format="%.2f")
profit_target_input = st.sidebar.number_input("Profit Target",
